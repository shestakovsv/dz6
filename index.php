...
//print_r($_POST);
    ...
    <form  method="post">
        ...
        <div id="f_location_id" class="form-row form-row-required"> <label for="region" class="form-label">Город</label> <select title="Выберите Ваш город" name="location_id" id="region" class="form-input-select"> <option value="">-- Выберите город --</option>
                ...
                <option data-coords=",," value="Краснообск">Краснообск</option>   
                <option data-coords=",," value="Куйбышев">Куйбышев</option>   
                <option data-coords=",," value="Мошково">Мошково</option>   
                <option data-coords=",," value="Обь">Обь</option>   
                <option data-coords=",," value="Ордынское">Ордынское</option>   
                <option data-coords=",," value="Черепаново">Черепаново</option>   
        ...
        <div id="f_metro_id"> <select title="Выберите станцию метро" name="metro_id" id="fld_metro_id" class="form-input-select"> <option value="">-- Выберите станцию метро --</option>
                <option value="Берёзовая роща">Берёзовая роща</option>
